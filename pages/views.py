...
from pages.forms import CategoryForm, PageForm
...
def about(request):
    ...
    return render_to_response('pages/about.html', context_dict , context)
...
def category(request, category_name_url):
    ...
    return render_to_response('pages/category.html', context_dict, context)
...
def add_category(request):
    ...
    return render_to_response('pages/add_category.html', context_dict, context)
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            # The account is inactive; tell by adding variable to the template context.
                ...
                return render_to_response('pages/login.html', context_dict, context)
...
def restricted(request):
    ...
    context_dict = {}
    context_dict['cat_list'] = cat_list
    return render_to_response('pages/restricted.html', context_dict, context)
...
def search(request):
    ...
    context_dict['result_list'] = result_list
    return render_to_response('pages/search.html', context_dict, context)
...
def profile(request):
    ...
    return render_to_response('pages/profile.html', context_dict, context)
...
def suggest_category(request):
    ...
    return render_to_response('pages/category_list.html', {'cat_list': cat_list }, context)
...
def auto_add_page(request):
    ...
    return render_to_response('pages/page_list.html', context_dict, context)
